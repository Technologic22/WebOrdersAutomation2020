...
public class AbstractBaseTest {
    ...
    protected static ExtentReports extentReports;     // when U make it static it works for multpile classes
    ...
    public void teardown(ITestResult testResult){
        if (testResult.getStatus()==ITestResult.FAILURE){
            ...
            try {
                extentTest.fail(testResult.getName());   //test name
                extentTest.addScreenCaptureFromPath(screenshotLocation); //scrnsht as an evidence
